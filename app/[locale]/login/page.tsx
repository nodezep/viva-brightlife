...
export default async function LoginPage({params}: {params: {locale: string}}) {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top,_rgba(7,112,148,0.20),_transparent_48%),radial-gradient(circle_at_20%_80%,_rgba(244,162,97,0.25),_transparent_50%),linear-gradient(135deg,_#f8f4ea,_#eef5f9_55%,_#f6efe2)] px-4">
      ...
      <div className="relative mx-auto flex min-h-screen w-full max-w-6xl flex-col items-center justify-center gap-10 py-10 sm:py-12 lg:flex-row lg:items-stretch">
        <div className="flex w-full flex-col justify-center gap-6 lg:w-1/2">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs uppercase tracking-[0.25em] text-[#5b7385]">
                Viva Brightlife
              </p>
              <p className="text-sm font-semibold text-[#1e3a4f]">
                Microfinance Co. Ltd
              </p>
            </div>
          </div>
          <p className="text-xs font-semibold uppercase tracking-[0.3em] text-[#0b4f6c]">
            Viva Brightlife Microfinance
          </p>
          <h1 className="text-3xl font-semibold leading-tight text-[#123248] sm:text-4xl lg:text-5xl font-[family:Georgia,serif]">
            A calmer, clearer way to manage loans and collections.
          </h1>
          <p className="max-w-xl text-sm leading-relaxed text-[#445566] sm:text-base">
          ...
          <div className="hidden max-w-xl grid-cols-2 gap-4 text-sm text-[#3a4f5f] sm:grid">
            <div className="rounded-2xl border border-white/60 bg-white/60 p-4 shadow-sm">
              <p className="text-xs uppercase tracking-[0.2em] text-[#5c7386]">Visibility</p>
              <p className="mt-2 font-semibold">Live repayment schedules</p>
            </div>
            <div className="rounded-2xl border border-white/60 bg-white/60 p-4 shadow-sm">
              <p className="text-xs uppercase tracking-[0.2em] text-[#5c7386]">Control</p>
